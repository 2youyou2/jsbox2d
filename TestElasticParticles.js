...
TestElasticParticles.prototype =
{
	Initialize: function()
	{
		{
...

		{
			...
			pd.flags = b2ParticleDef.b2_elasticParticle;
			pd.groupFlags = b2ParticleGroup.b2_solidParticleGroup;
			pd.shape = shape;
...
TestElasticParticles._extend(Test);