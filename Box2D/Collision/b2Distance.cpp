...
void b2Simplex::Solve2()
{
	...
	// w1 region
	float32 d12_2 = -b2Dot_v2_v2(w1, e12);
	if (d12_2 <= 0.0)
	{
	...
	// w2 region
	float32 d12_1 = b2Dot_v2_v2(w2, e12);
	if (d12_1 <= 0.0)
	{
...
void b2Simplex::Solve3()
{
	...
	// a3 = 0
	b2Vec2 e12 = b2Vec2::Subtract(w2, w1);
	float32 w1e12 = b2Dot_v2_v2(w1, e12);
	float32 w2e12 = b2Dot_v2_v2(w2, e12);
	float32 d12_1 = w2e12;
	float32 d12_2 = -w1e12;
	...
	// [w1.e13 w3.e13][a3] = [0]
	// a2 = 0
	b2Vec2 e13 = b2Vec2::Subtract(w3, w1);
	float32 w1e13 = b2Dot_v2_v2(w1, e13);
	float32 w3e13 = b2Dot_v2_v2(w3, e13);
	float32 d13_1 = w3e13;
	float32 d13_2 = -w1e13;
	...
	// [w2.e23 w3.e23][a3] = [0]
	// a1 = 0
	b2Vec2 e23 = b2Vec2::Subtract(w3, w2);
	float32 w2e23 = b2Dot_v2_v2(w2, e23);
	float32 w3e23 = b2Dot_v2_v2(w3, e23);
	float32 d23_1 = w3e23;
	float32 d23_2 = -w2e23;

	// Triangle123
	float32 n123 = b2Cross_v2_v2(e12, e13);

	float32 d123_1 = n123 * b2Cross_v2_v2(w2, w3);
	float32 d123_2 = n123 * b2Cross_v2_v2(w3, w1);
	float32 d123_3 = n123 * b2Cross_v2_v2(w1, w2);
...
void b2DistanceFunc(b2DistanceOutput* output,
				...
				const b2DistanceInput* input)
{
	...
	if (input->useRadii)
	{
		...
		if (output->distance > rA + rB && output->distance > b2_epsilon)
		{
			...
			b2Vec2 normal = b2Vec2::Subtract(output->pointB, output->pointA);
			normal.Normalize();
