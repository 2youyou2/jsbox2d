...
this.m_normals=Array(wa);Object.seal(this)}function rc(){this.proxyIdB=this.proxyIdA=0}function sc(a,b){return a.proxyIdA==b.proxyIdA?a.proxyIdB-b.proxyIdB:a.proxyIdA-b.proxyIdA}function Ga(){this.m_tree=new Ha;this.m_pairCount=this.m_proxyCount=this.m_queryProxyId=0;this.m_pairBuffer=[];this.m_moveCount=0;this.m_moveBuffer=[]}function Ra(){this.m_vertices=null;this.m_radius=this.m_count=0}function Nb(){this.count=this.metric=0;this.indexA=[0,0,0];this.indexB=[0,0,0]}function Ob(){this.proxyA=new Ra;
this.proxyB=new Ra;this.transformA=new Y;this.transformB=new Y;this.useRadii=!1}function Pb(){this.pointA=new d;this.pointB=new d;this.iterations=this.distance=0}function bb(){this.wA=new d;this.wB=new d;this.w=new d;this.indexB=this.indexA=this.a=0}function Qb(){this.m_v=[new bb,new bb,new bb];this.m_count=0}function xa(a,b,c){++xa.b2_gjkCalls;var e=c.proxyA,f=c.proxyB,g=c.transformA,k=c.transformB;ka.ReadCache(b,e,g,f,k);for(var d=ka.m_v,l=[0,0,0],m=[0,0,0],n=0,p=0;20>p;){for(var n=ka.m_count,q=
...
new d;this.m_axis=new d}function R(a,b){ub.start();++R.b2_toiCalls;a.state=ha.e_unknown;a.t=b.tMax;var c=b.proxyA,e=b.proxyB;R._temp_sweepA.Assign(b.sweepA);R._temp_sweepB.Assign(b.sweepB);R._temp_sweepA.Normalize();R._temp_sweepB.Normalize();var f=b.tMax,g=H(Q,c.m_radius+e.m_radius-3*Q),d=0.25*Q,h=0,l=0,m=new Nb;m.count=0;var n=new Ob;n.proxyA.Assign(b.proxyA);n.proxyB.Assign(b.proxyB);for(n.useRadii=!1;;){R._temp_sweepA.GetTransform(n.transformA,h);R._temp_sweepB.GetTransform(n.transformB,h);var p=
new Pb;xa(p,m,n);if(0>=p.distance){a.state=ha.e_overlapped;a.t=0;break}if(p.distance<g+d){a.state=ha.e_touching;a.t=h;break}p=new ia;p.Initialize(m,c,R._temp_sweepA,e,R._temp_sweepB,h);for(var q=!1,r=f,J=0;;){var y=[],s=p.FindMinSeparation(y,r);if(s>g+d){a.state=ha.e_separated;a.t=f;q=!0;break}if(s>g-d){h=r;break}var t=p.Evaluate(y[0],y[1],h);if(t<g-d){a.state=ha.e_failed;a.t=h;q=!0;break}if(t<=g+d){a.state=ha.e_touching;a.t=h;q=!0;break}for(var x=0,A=h,u=r;;){var v;v=x&1?A+(g-t)*(u-A)/(s-t):0.5*
...
this.fixture=null;this.proxyId=this.childIndex=0}function Vb(){this.m_proxies=this.m_next=this.m_body=this.m_userData=null;this.m_proxyCount=0;this.m_shape=null;this.m_density=0;this.m_filter=new eb;this.m_isSensor=!1;this.m_restitution=this.m_friction=0}function zc(){}function Wb(){}function Ac(){this.normalImpulses=Array(na);this.tangentImpulses=Array(na);this.count=0}function Xb(){}function Bc(){}function Cc(){}function gb(){this.positionIterations=this.velocityIterations=this.dtRatio=this.inv_dt=
this.dt=0;this.warmStarting=!1}function Dc(){this.c=new d;this.a=0}function Ec(){this.v=new d;this.w=0}function Fc(){this.step=new gb;this.velocities=this.positions=null}function P(a){this.m_contactManager=new Yb;this.m_jointList=this.m_bodyList=this.g_debugDraw=this.m_destructionListener=null;this.m_jointCount=this.m_bodyCount=0;this.m_continuousPhysics=this.m_warmStarting=!0;this.m_subStepping=!1;this.m_allowSleep=this.m_stepComplete=!0;this.m_gravity=a;this.m_flags=P.e_clearForces;this.m_inv_dt0=
...
this.m_powderStrength=0.5;this.m_world=null}function ya(a,b){return(b+D.yOffset<<D.yShift)+(D.xScale*a+D.xOffset)>>>0}function Ta(a,b){return b&&a>b?b:a}function cd(a){return(a.flags&I.b2_zombieParticle)==I.b2_zombieParticle}function Zb(a,b){return a>b?a:b}function $b(){this.fcn=null;this.primary=!1}function ac(){this.next=this.prev=this.contact=this.other=null}function w(){this.m_nodeA=new ac;this.m_nodeB=new ac;this.m_manifold=new L}function wb(){this.parent.call(this)}function xb(){this.parent.call(this)}
function Ua(){this.parent.call(this)}function Va(){this.parent.call(this)}function Wa(){this.parent.call(this)}function Xa(){this.parent.call(this)}function Ya(){this.parent.call(this)}function Yb(){this.m_broadPhase=new Ga;this.m_contactList=null;this.m_contactCount=0;this.m_contactFilter=Jc;this.m_contactListener=Kc}function Lc(){this.rA=new d;this.rB=new d;this.velocityBias=this.tangentMass=this.normalMass=this.tangentImpulse=this.normalImpulse=0}function Mc(){this.localPoints=Array(na);this.localNormal=
...
new d;this.localAnchorB=new d;this.localAxisA=new d(1,0);this.enableMotor=!1;this.motorSpeed=this.maxMotorTorque=0;this.frequencyHz=2;this.dampingRatio=0.7;Object.seal(this)}function Eb(a){this.parent.call(this,a);this.m_indexB=this.m_indexA=0;this.m_localCenterA=new d;this.m_localCenterB=new d;this.m_invIB=this.m_invIA=this.m_invMassB=this.m_invMassA=0;this.m_localAnchorA=a.localAnchorA.Clone();this.m_localAnchorB=a.localAnchorB.Clone();this.m_localXAxisA=a.localAxisA.Clone();this.m_localYAxisA=
S(1,this.m_localXAxisA);this.m_springImpulse=this.m_springMass=this.m_motorImpulse=this.m_motorMass=this.m_impulse=this.m_mass=0;this.m_maxMotorTorque=a.maxMotorTorque;this.m_motorSpeed=a.motorSpeed;this.m_enableMotor=a.enableMotor;this.m_frequencyHz=a.frequencyHz;this.m_dampingRatio=a.dampingRatio;this.m_gamma=this.m_bias=0;this.m_ax=new d;this.m_ay=new d;this.m_sAy=this.m_sBy=this.m_sAx=this.m_sBx=0}function Fb(){this.parent.call(this);this.type=s.e_gearJoint;this.joint2=this.joint1=null;this.ratio=
1;Object.seal(this)}function Gb(a){this.parent.call(this,a);this.m_joint1=a.joint1;this.m_joint2=a.joint2;this.m_typeA=this.m_joint1.GetType();this.m_typeB=this.m_joint2.GetType();var b,c;this.m_bodyC=this.m_joint1.GetBodyA();this.m_bodyA=this.m_joint1.GetBodyB();b=this.m_bodyA.m_xf;var e=this.m_bodyA.m_sweep.a;c=this.m_bodyC.m_xf;var f=this.m_bodyC.m_sweep.a;this.m_localAnchorA=new d;this.m_localAnchorB=new d;this.m_localAnchorC=new d;this.m_localAnchorD=new d;this.m_localAxisC=new d;this.m_localAxisD=
...
a.index=e;a.separation=d;break}if(0<=f*b+g*c){if((f-this.m_upperLimit.x)*this.m_normal.x+(g-this.m_upperLimit.y)*this.m_normal.y<-za)continue}else if((f-this.m_lowerLimit.x)*this.m_normal.x+(g-this.m_lowerLimit.y)*this.m_normal.y<-za)continue;d>a.separation&&(a.type=da.e_edgeB,a.index=e,a.separation=d)}return a}};M.e_isolated=0;M.e_concave=1;M.e_convex=2;db.collider=new M;ga.input=new Ob;ga.cache=new Nb;ga.output=new Pb;var T=-1;Sa.prototype={IsLeaf:function(){return this.child1==T}};Ha.aabbExtensionFattener=
...
a.maskBits;this.groupIndex=a.groupIndex},_serialize:function(a){a=a||{};a.categoryBits=this.categoryBits;a.maskBits=this.maskBits;a.groupIndex=this.groupIndex;return a},_deserialize:function(a){this.categoryBits=a.categoryBits;this.maskBits=a.maskBits;this.groupIndex=a.groupIndex}};fb.prototype={_deserialize:function(a){this.friction=a.friction;this.restitution=a.restitution;this.density=a.density;this.isSensor=a.isSensor;this.filter._deserialize(a.filter)}};Vb.prototype={GetType:function(){return this.m_shape.GetType()},
...
c)};Xa._extend(w);Ya.prototype={Evaluate:function(a,b,c){fa(a,this.m_fixtureA.GetShape(),b,this.m_fixtureB.GetShape(),c)},Create:function(a,b,c,e){this.parent.prototype.Create.call(this,a,0,c,0)}};Ya.Create=function(a,b,c,e){return new Ya(a,c)};Ya._extend(w);w.AddType=function(a,b,c){w.s_registers[b]||(w.s_registers[b]=[]);w.s_registers[b][c]=new $b;w.s_registers[b][c].fcn=a;w.s_registers[b][c].primary=!0;b!=c&&(w.s_registers[c]||(w.s_registers[c]=[]),w.s_registers[c][b]=new $b,w.s_registers[c][b].fcn=
a,w.s_registers[c][b].primary=!1);a.garbage=[];a.alloc=2};w.InitializeRegisters=function(){w.AddType(wb,G.e_circle,G.e_circle);w.AddType(Xa,G.e_polygon,G.e_circle);w.AddType(Ya,G.e_polygon,G.e_polygon);w.AddType(Va,G.e_edge,G.e_circle);w.AddType(Wa,G.e_edge,G.e_polygon);w.AddType(xb,G.e_chain,G.e_circle);w.AddType(Ua,G.e_chain,G.e_polygon)};w.RetrieveGarbage=function(a){var b;if(b=a.garbage.pop())return b;for(b=0;b<a.alloc-1;++b)a.garbage.push(new a);a.alloc+=32;return new a};w.Create=function(a,
...
a.m_nodeB.Clear();w.s_registers[b][c].fcn.garbage.push(a)};w.s_registers=[];w.s_initialized=!1;var Jc=new Wb,Kc=new Xb;Yb.prototype={AddPair:function(a,b){var c=a.fixture,e=b.fixture,f=a.childIndex,d=b.childIndex,k=c.GetBody(),h=e.GetBody();if(k!=h){for(var l=h.GetContactList();l;){if(l.other==k){var m=l.contact.GetFixtureA(),n=l.contact.GetFixtureB(),p=l.contact.GetChildIndexA(),q=l.contact.GetChildIndexB();if(m==c&&n==e&&p==f&&q==d||m==e&&n==c&&p==d&&q==f)return}l=l.next}!1==h.ShouldCollide(k)||
this.m_contactFilter&&!1==this.m_contactFilter.ShouldCollide(c,e)||(f=w.Create(c,f,e,d),null!=f&&(c=f.GetFixtureA(),e=f.GetFixtureB(),f.GetChildIndexA(),f.GetChildIndexB(),k=c.GetBody(),h=e.GetBody(),f.m_prev=null,f.m_next=this.m_contactList,null!=this.m_contactList&&(this.m_contactList.m_prev=f),this.m_contactList=f,f.m_nodeA.contact=f,f.m_nodeA.other=h,f.m_nodeA.prev=null,f.m_nodeA.next=k.m_contactList,null!=k.m_contactList&&(k.m_contactList.prev=f.m_nodeA),k.m_contactList=f.m_nodeA,f.m_nodeB.contact=
...
a.m_next);a.m_next&&(a.m_next.m_prev=a.m_prev);a==this.m_contactList&&(this.m_contactList=a.m_next);a.m_nodeA.prev&&(a.m_nodeA.prev.next=a.m_nodeA.next);a.m_nodeA.next&&(a.m_nodeA.next.prev=a.m_nodeA.prev);a.m_nodeA==b.m_contactList&&(b.m_contactList=a.m_nodeA.next);a.m_nodeB.prev&&(a.m_nodeB.prev.next=a.m_nodeB.next);a.m_nodeB.next&&(a.m_nodeB.next.prev=a.m_nodeB.prev);a.m_nodeB==c.m_contactList&&(c.m_contactList=a.m_nodeB.next);w.Destroy(a);--this.m_contactCount},Collide:function(){for(var a=this.m_contactList;a;){var b=
a.GetFixtureA(),c=a.GetFixtureB(),e=a.GetChildIndexA(),f=a.GetChildIndexB(),d=b.GetBody(),k=c.GetBody();if(a.m_flags&w.e_filterFlag){if(!1==k.ShouldCollide(d)){b=a;a=b.GetNext();this.Destroy(b);continue}if(this.m_contactFilter&&!1==this.m_contactFilter.ShouldCollide(b,c)){b=a;a=b.GetNext();this.Destroy(b);continue}a.m_flags&=~w.e_filterFlag}d=d.IsAwake()&&d.m_type!=t.b2_staticBody;k=k.IsAwake()&&k.m_type!=t.b2_staticBody;!1==d&&!1==k?a=a.GetNext():!1==this.m_broadPhase.TestOverlap(b.m_proxies[e].proxyId,
c.m_proxies[f].proxyId)?(b=a,a=b.GetNext(),this.Destroy(b)):(a.Update(this.m_contactListener),a=a.GetNext())}}};bc.prototype={Initialize:function(a,b,c,e){switch(a.type){case L.e_circles:var f=b.q.c*a.localPoint.x-b.q.s*a.localPoint.y+b.p.x;b=b.q.s*a.localPoint.x+b.q.c*a.localPoint.y+b.p.y;var d=c.q.c*a.localPoints[0].x-c.q.s*a.localPoints[0].y+c.p.x;c=c.q.s*a.localPoints[0].x+c.q.c*a.localPoints[0].y+c.p.y;this.point.x=0.5*(f+d);this.point.y=0.5*(b+c);this.normal.x=d-f;this.normal.y=c-b;c=this.normal.x;
b=this.normal.y;this.normal.Normalize();this.separation=c*this.normal.x+b*this.normal.y-a.radiusA-a.radiusB;break;case L.e_faceA:this.normal.x=b.q.c*a.localNormal.x-b.q.s*a.localNormal.y;this.normal.y=b.q.s*a.localNormal.x+b.q.c*a.localNormal.y;var f=b.q.c*a.localPoint.x-b.q.s*a.localPoint.y+b.p.x,d=b.q.s*a.localPoint.x+b.q.c*a.localPoint.y+b.p.y,k=c.q.c*a.localPoints[e].x-c.q.s*a.localPoints[e].y+c.p.x;c=c.q.s*a.localPoints[e].x+c.q.c*a.localPoints[e].y+c.p.y;this.separation=(k-f)*this.normal.x+
(c-d)*this.normal.y-a.radiusA-a.radiusB;this.point.x=k;this.point.y=c;break;case L.e_faceB:this.normal.x=c.q.c*a.localNormal.x-c.q.s*a.localNormal.y,this.normal.y=c.q.s*a.localNormal.x+c.q.c*a.localNormal.y,f=c.q.c*a.localPoint.x-c.q.s*a.localPoint.y+c.p.x,d=c.q.s*a.localPoint.x+c.q.c*a.localPoint.y+c.p.y,k=b.q.c*a.localPoints[e].x-b.q.s*a.localPoints[e].y+b.p.x,c=b.q.s*a.localPoints[e].x+b.q.c*a.localPoints[e].y+b.p.y,this.separation=(k-f)*this.normal.x+(c-d)*this.normal.y-a.radiusA-a.radiusB,this.point.x=
k,this.point.y=c,this.normal.x=-this.normal.x,this.normal.y=-this.normal.y}}};E.cs_xfA=new Y;E.cs_xfB=new Y;E.temp_solver_manifold=new bc;E.prototype={Init:function(a){this.m_step=a.step;this.m_count=a.count;this.m_positionConstraints.length=this.m_count;this.m_velocityConstraints.length=this.m_count;this.m_positions=a.positions;this.m_velocities=a.velocities;this.m_contacts=a.contacts;for(a=0;a<this.m_count;++a){var b=this.m_contacts[a],c=b.m_fixtureA,e=b.m_fixtureB,f=c.GetShape(),d=e.GetShape(),
f=f.m_radius,k=d.m_radius,h=c.GetBody(),l=e.GetBody(),e=b.GetManifold(),c=e.pointCount,d=this.m_velocityConstraints[a]||new Nc;d.friction=b.m_friction;d.restitution=b.m_restitution;d.tangentSpeed=b.m_tangentSpeed;d.indexA=h.m_islandIndex;d.indexB=l.m_islandIndex;d.invMassA=h.m_invMass;d.invMassB=l.m_invMass;d.invIA=h.m_invI;d.invIB=l.m_invI;d.contactIndex=a;d.pointCount=c;d.K.SetZero();d.normalMass.SetZero();this.m_velocityConstraints[a]=d;b=this.m_positionConstraints[a]||new Mc;b.indexA=h.m_islandIndex;
b.indexB=l.m_islandIndex;b.invMassA=h.m_invMass;b.invMassB=l.m_invMass;b.localCenterA.x=h.m_sweep.localCenter.x;b.localCenterA.y=h.m_sweep.localCenter.y;b.localCenterB.x=l.m_sweep.localCenter.x;b.localCenterB.y=l.m_sweep.localCenter.y;b.invIA=h.m_invI;b.invIB=l.m_invI;b.localNormal.x=e.localNormal.x;b.localNormal.y=e.localNormal.y;b.localPoint.x=e.localPoint.x;b.localPoint.y=e.localPoint.y;b.pointCount=c;b.radiusA=f;b.radiusB=k;b.type=e.type;this.m_positionConstraints[a]=b;for(f=0;f<c;++f)k=e.points[f],
h=d.points[f],this.m_step.warmStarting?(h.normalImpulse=this.m_step.dtRatio*k.normalImpulse,h.tangentImpulse=this.m_step.dtRatio*k.tangentImpulse):(h.normalImpulse=0,h.tangentImpulse=0),h.rA.SetZero(),h.rB.SetZero(),h.normalMass=0,h.tangentMass=0,h.velocityBias=0,b.localPoints[f]=k.localPoint}},InitializeVelocityConstraints:function(){for(var a=0;a<this.m_count;++a){var b=this.m_velocityConstraints[a],c=this.m_positionConstraints[a],e=c.radiusA,f=c.radiusB,d=this.m_contacts[b.contactIndex].GetManifold(),
k=b.indexA,h=b.indexB,l=b.invMassA,m=b.invMassB,n=b.invIA,p=b.invIB,q=c.localCenterA,r=c.localCenterB,c=this.m_positions[k].c,J=this.m_velocities[k].v,y=this.m_velocities[k].w,s=this.m_positions[h].c,t=this.m_positions[h].a,x=this.m_velocities[h].v,h=this.m_velocities[h].w;E.cs_xfA.q.Set(this.m_positions[k].a);E.cs_xfB.q.Set(t);E.cs_xfA.p.x=c.x-(E.cs_xfA.q.c*q.x-E.cs_xfA.q.s*q.y);E.cs_xfA.p.y=c.y-(E.cs_xfA.q.s*q.x+E.cs_xfA.q.c*q.y);E.cs_xfB.p.x=s.x-(E.cs_xfB.q.c*r.x-E.cs_xfB.q.s*r.y);E.cs_xfB.p.y=
s.y-(E.cs_xfB.q.s*r.x+E.cs_xfB.q.c*r.y);k=new Rb;k.Initialize(d,E.cs_xfA,e,E.cs_xfB,f);b.normal.x=k.normal.x;b.normal.y=k.normal.y;e=b.pointCount;for(f=0;f<e;++f)d=b.points[f],d.rA.x=k.points[f].x-c.x,d.rA.y=k.points[f].y-c.y,d.rB.x=k.points[f].x-s.x,d.rB.y=k.points[f].y-s.y,q=d.rA.x*b.normal.y-d.rA.y*b.normal.x,r=d.rB.x*b.normal.y-d.rB.y*b.normal.x,q=l+m+n*q*q+p*r*r,d.normalMass=0<q?1/q:0,r=1*b.normal.y,t=-1*b.normal.x,q=d.rA.x*t-d.rA.y*r,r=d.rB.x*t-d.rB.y*r,q=l+m+n*q*q+p*r*r,d.tangentMass=0<q?1/
q:0,d.velocityBias=0,q=b.normal.x*(x.x+-h*d.rB.y-J.x- -y*d.rA.y)+b.normal.y*(x.y+h*d.rB.x-J.y-y*d.rA.x),-1>q&&(d.velocityBias=-b.restitution*q);2==b.pointCount&&(J=b.points[0],s=b.points[1],c=J.rA.x*b.normal.y-J.rA.y*b.normal.x,J=J.rB.x*b.normal.y-J.rB.y*b.normal.x,y=s.rA.x*b.normal.y-s.rA.y*b.normal.x,h=s.rB.x*b.normal.y-s.rB.y*b.normal.x,s=l+m+n*c*c+p*J*J,x=l+m+n*y*y+p*h*h,l=l+m+n*c*y+p*J*h,s*s<1E3*(s*x-l*l)?(b.K.ex.x=s,b.K.ex.y=l,b.K.ey.x=l,b.K.ey.y=x,b.normalMass.Assign(b.K.GetInverse())):b.pointCount=
1)}},WarmStart:function(){for(var a=0;a<this.m_count;++a){for(var b=this.m_velocityConstraints[a],c=b.indexA,e=b.indexB,f=b.invMassA,d=b.invIA,k=b.invMassB,h=b.invIB,l=b.pointCount,m=this.m_velocities[c].v,n=this.m_velocities[c].w,p=this.m_velocities[e].v,q=this.m_velocities[e].w,r=b.normal,s=1*r.y,y=-1*r.x,t=0;t<l;++t){var u=b.points[t],x=u.normalImpulse*r.x+u.tangentImpulse*s,A=u.normalImpulse*r.y+u.tangentImpulse*y,n=n-d*(u.rA.x*A-u.rA.y*x);m.x-=f*x;m.y-=f*A;q+=h*(u.rB.x*A-u.rB.y*x);p.x+=k*x;p.y+=
k*A}this.m_velocities[c].w=n;this.m_velocities[e].w=q}},SolveVelocityConstraints:function(){for(var a=0;a<this.m_count;++a){for(var b=this.m_velocityConstraints[a],c=b.indexA,e=b.indexB,d=b.invMassA,g=b.invIA,k=b.invMassB,h=b.invIB,l=b.pointCount,m=this.m_velocities[c].v,n=this.m_velocities[c].w,p=this.m_velocities[e].v,q=this.m_velocities[e].w,r=b.normal,s=1*r.y,y=-1*r.x,t=b.friction,u=0;u<l;++u){var x=b.points[u],A=p.x+-q*x.rB.y-m.x- -n*x.rA.y,v=p.y+q*x.rB.x-m.y-n*x.rA.x,A=x.tangentMass*-(A*s+v*
y-b.tangentSpeed),v=t*x.normalImpulse,v=ca(x.tangentImpulse+A,-v,v),A=v-x.tangentImpulse;x.tangentImpulse=v;v=A*s;A*=y;m.x-=d*v;m.y-=d*A;n-=g*(x.rA.x*A-x.rA.y*v);p.x+=k*v;p.y+=k*A;q+=h*(x.rB.x*A-x.rB.y*v)}if(1==b.pointCount)x=b.points[0],A=p.x+-q*x.rB.y-m.x- -n*x.rA.y,v=p.y+q*x.rB.x-m.y-n*x.rA.x,A=-x.normalMass*(A*r.x+v*r.y-x.velocityBias),v=H(x.normalImpulse+A,0),A=v-x.normalImpulse,x.normalImpulse=v,v=A*r.x,A*=r.y,m.x-=d*v,m.y-=d*A,n-=g*(x.rA.x*A-x.rA.y*v),p.x+=k*v,p.y+=k*A,q+=h*(x.rB.x*A-x.rB.y*
v);else for(var l=b.points[0],s=b.points[1],x=l.normalImpulse,u=s.normalImpulse,A=(p.x+-q*l.rB.y-m.x- -n*l.rA.y)*r.x+(p.y+q*l.rB.x-m.y-n*l.rA.x)*r.y,v=(p.x+-q*s.rB.y-m.x- -n*s.rA.y)*r.x+(p.y+q*s.rB.x-m.y-n*s.rA.x)*r.y,w=A-l.velocityBias,C=v-s.velocityBias,w=w-(b.K.ex.x*x+b.K.ey.x*u),C=C-(b.K.ex.y*x+b.K.ey.y*u);;){y=-(b.normalMass.ex.x*w+b.normalMass.ey.x*C);t=-(b.normalMass.ex.y*w+b.normalMass.ey.y*C);if(0<=y&&0<=t){x=y-x;u=t-u;b=x*r.x;x*=r.y;A=u*r.x;r=u*r.y;m.x-=d*(b+A);m.y-=d*(x+r);n-=g*(l.rA.x*
x-l.rA.y*b+(s.rA.x*r-s.rA.y*A));p.x+=k*(b+A);p.y+=k*(x+r);q+=h*(l.rB.x*x-l.rB.y*b+(s.rB.x*r-s.rB.y*A));l.normalImpulse=y;s.normalImpulse=t;break}y=-l.normalMass*w;t=0;v=b.K.ex.y*y+C;if(0<=y&&0<=v){x=y-x;u=t-u;b=x*r.x;x*=r.y;A=u*r.x;r=u*r.y;m.x-=d*(b+A);m.y-=d*(x+r);n-=g*(l.rA.x*x-l.rA.y*b+(s.rA.x*r-s.rA.y*A));p.x+=k*(b+A);p.y+=k*(x+r);q+=h*(l.rB.x*x-l.rB.y*b+(s.rB.x*r-s.rB.y*A));l.normalImpulse=y;s.normalImpulse=t;break}y=0;t=-s.normalMass*C;A=b.K.ey.x*t+w;if(0<=t&&0<=A){x=y-x;u=t-u;b=x*r.x;x*=r.y;
A=u*r.x;r=u*r.y;m.x-=d*(b+A);m.y-=d*(x+r);n-=g*(l.rA.x*x-l.rA.y*b+(s.rA.x*r-s.rA.y*A));p.x+=k*(b+A);p.y+=k*(x+r);q+=h*(l.rB.x*x-l.rB.y*b+(s.rB.x*r-s.rB.y*A));l.normalImpulse=y;s.normalImpulse=t;break}t=y=0;A=w;v=C;if(0<=A&&0<=v){x=y-x;u=t-u;b=x*r.x;x*=r.y;A=u*r.x;r=u*r.y;m.x-=d*(b+A);m.y-=d*(x+r);n-=g*(l.rA.x*x-l.rA.y*b+(s.rA.x*r-s.rA.y*A));p.x+=k*(b+A);p.y+=k*(x+r);q+=h*(l.rB.x*x-l.rB.y*b+(s.rB.x*r-s.rB.y*A));l.normalImpulse=y;s.normalImpulse=t;break}break}this.m_velocities[c].w=n;this.m_velocities[e].w=
q}},StoreImpulses:function(){for(var a=0;a<this.m_count;++a)for(var b=this.m_velocityConstraints[a],c=this.m_contacts[b.contactIndex].GetManifold(),e=0;e<b.pointCount;++e)c.points[e].normalImpulse=b.points[e].normalImpulse,c.points[e].tangentImpulse=b.points[e].tangentImpulse},SolvePositionConstraints:function(){for(var a=0,b=0;b<this.m_count;++b){for(var c=this.m_positionConstraints[b],e=c.indexA,d=c.indexB,g=c.localCenterA,k=c.invMassA,h=c.invIA,l=c.localCenterB,m=c.invMassB,n=c.invIB,p=c.pointCount,
q=this.m_positions[e].c,r=this.m_positions[e].a,s=this.m_positions[d].c,t=this.m_positions[d].a,u=0;u<p;++u){E.cs_xfA.q.Set(r);E.cs_xfB.q.Set(t);E.cs_xfA.p.x=q.x-(E.cs_xfA.q.c*g.x-E.cs_xfA.q.s*g.y);E.cs_xfA.p.y=q.y-(E.cs_xfA.q.s*g.x+E.cs_xfA.q.c*g.y);E.cs_xfB.p.x=s.x-(E.cs_xfB.q.c*l.x-E.cs_xfB.q.s*l.y);E.cs_xfB.p.y=s.y-(E.cs_xfB.q.s*l.x+E.cs_xfB.q.c*l.y);E.temp_solver_manifold.Initialize(c,E.cs_xfA,E.cs_xfB,u);var v=E.temp_solver_manifold.normal,x=E.temp_solver_manifold.point,A=E.temp_solver_manifold.separation,
w=x.x-q.x,C=x.y-q.y,B=x.x-s.x,x=x.y-s.y,a=O(a,A),A=ca(0.2*(A+Q),-0.2,0),z=w*v.y-C*v.x,D=B*v.y-x*v.x,z=k+m+h*z*z+n*D*D,z=0<z?-A/z:0,A=z*v.x,v=z*v.y;q.x-=k*A;q.y-=k*v;r-=h*(w*v-C*A);s.x+=m*A;s.y+=m*v;t+=n*(B*v-x*A)}this.m_positions[e].a=r;this.m_positions[d].a=t}return a>=-3*Q},SolveTOIPositionConstraints:function(a,b){for(var c=0,e=0;e<this.m_count;++e){var f=this.m_positionConstraints[e],g=f.indexA,k=f.indexB,h=f.localCenterA,l=f.localCenterB,m=f.pointCount,n=0,p=0;if(g==a||g==b)n=f.invMassA,p=f.invIA;
var q=0,r=0;if(k==a||k==b)q=f.invMassB,r=f.invIB;for(var s=this.m_positions[g].c,t=this.m_positions[g].a,v=this.m_positions[k].c,w=this.m_positions[k].a,x=0;x<m;++x){E.cs_xfA.q.Set(t);E.cs_xfB.q.Set(w);E.cs_xfA.p.Assign(d.Subtract(s,C(E.cs_xfA.q,h)));E.cs_xfB.p.Assign(d.Subtract(v,C(E.cs_xfB.q,l)));E.temp_solver_manifold.Initialize(f,E.cs_xfA,E.cs_xfB,x);var A=E.temp_solver_manifold.normal,z=E.temp_solver_manifold.point,B=E.temp_solver_manifold.separation,D=d.Subtract(z,s),z=d.Subtract(z,v),c=O(c,
B),B=ca(0.75*(B+Q),-0.2,0),F=u(D,A),H=u(z,A),F=n+q+p*F*F+r*H*H,A=d.Multiply(0<F?-B/F:0,A);s.Subtract(d.Multiply(n,A));t-=p*u(D,A);v.Add(d.Multiply(q,A));w+=r*u(z,A)}this.m_positions[g].a=t;this.m_positions[k].a=w}return c>=-1.5*Q}};var Wc=ua.create("solve initialization","solve"),Xc=ua.create("warm starting","solve initialization"),Yc=ua.create("solve velocities","solve"),Zc=ua.create("solve positions","solve");K._solverData=new Fc;K._solverDef=new Oc;K._solver=new E;K.prototype={Clear:function(){this.m_jointCount=
this.m_contactCount=this.m_bodyCount=0},Initialize:function(a,b,c,e){this.m_listener=e;this.m_bodyCapacity=a;this.m_contactCapacity=b;this.m_jointCapacity=c;this.m_jointCount=this.m_contactCount=this.m_bodyCount=0;this.m_bodies.length=a;this.m_contacts.length=b;this.m_joints.length=c;this.m_velocities.length=a;this.m_positions.length=a},Solve:function(a,b,c){Wc.start();for(var e=a.dt,d=0;d<this.m_bodyCount;++d){var g=this.m_bodies[d];this.m_positions[d].c.Assign(g.m_sweep.c);var k=g.m_sweep.a;this.m_velocities[d].v.Assign(g.m_linearVelocity);
var h=g.m_angularVelocity;g.m_sweep.c0.Assign(g.m_sweep.c);g.m_sweep.a0=g.m_sweep.a;g.m_type==t.b2_dynamicBody&&(this.m_velocities[d].v.x+=e*(g.m_gravityScale*b.x+g.m_invMass*g.m_force.x),this.m_velocities[d].v.y+=e*(g.m_gravityScale*b.y+g.m_invMass*g.m_force.y),h+=e*g.m_invI*g.m_torque,this.m_velocities[d].v.x*=1/(1+e*g.m_linearDamping),this.m_velocities[d].v.y*=1/(1+e*g.m_linearDamping),h*=1/(1+e*g.m_angularDamping));this.m_positions[d].a=k;this.m_velocities[d].w=h}K._solverData.step=a;K._solverData.positions=
this.m_positions;K._solverData.velocities=this.m_velocities;K._solverDef.step=a;K._solverDef.contacts=this.m_contacts;K._solverDef.count=this.m_contactCount;K._solverDef.positions=this.m_positions;K._solverDef.velocities=this.m_velocities;K._solverDef.allocator=this.m_allocator;K._solver.Init(K._solverDef);K._solver.InitializeVelocityConstraints();a.warmStarting&&(Xc.start(),K._solver.WarmStart(),Xc.stop());for(d=0;d<this.m_jointCount;++d)this.m_joints[d].InitVelocityConstraints(K._solverData);Wc.stop();
Yc.start();for(d=0;d<a.velocityIterations;++d){for(h=0;h<this.m_jointCount;++h)this.m_joints[h].SolveVelocityConstraints(K._solverData);K._solver.SolveVelocityConstraints()}K._solver.StoreImpulses();Yc.stop();Zc.start();for(d=0;d<this.m_bodyCount;++d){g=this.m_positions[d].c;k=this.m_positions[d].a;b=this.m_velocities[d].v;var h=this.m_velocities[d].w,l=e*b.x,m=e*b.y,l=l*l+m*m;4<l&&(l=2/va(l),b.x*=l,b.y*=l);l=e*h;l*l>dc&&(l=qb/aa(l),h*=l);g.x+=e*b.x;g.y+=e*b.y;k+=e*h;this.m_positions[d].a=k;this.m_velocities[d].w=
h}k=!1;for(d=0;d<a.positionIterations;++d){g=K._solver.SolvePositionConstraints();b=!0;for(h=0;h<this.m_jointCount;++h)l=this.m_joints[h].SolvePositionConstraints(K._solverData),b=b&&l;if(g&&b){k=!0;break}}for(d=0;d<this.m_bodyCount;++d)a=this.m_bodies[d],a.m_sweep.c.Assign(this.m_positions[d].c),a.m_sweep.a=this.m_positions[d].a,a.m_linearVelocity.Assign(this.m_velocities[d].v),a.m_angularVelocity=this.m_velocities[d].w,a.SynchronizeTransform();Zc.stop();this.Report(K._solver.m_velocityConstraints);
...
new Ab(a);break;case s.e_mouseJoint:b=new zb(a);break;case s.e_prismaticJoint:b=new Bb(a);break;case s.e_revoluteJoint:b=new yb(a);break;case s.e_pulleyJoint:b=new Jb(a);break;case s.e_gearJoint:b=new Gb(a);break;case s.e_wheelJoint:b=new Eb(a);break;case s.e_weldJoint:b=new Db(a);break;case s.e_frictionJoint:b=new Cb(a);break;case s.e_ropeJoint:b=new Kb(a);break;case s.e_motorJoint:b=new Hb(a)}return b};s.Destroy=function(a){};hb.prototype={Initialize:function(a,b,c){this.bodyA=a;this.bodyB=b;this.localAnchorA=
...
a.localAxisA=this.m_localAxisA._serialize();a.enableMotor=this.m_enableMotor;a.maxMotorTorque=this.m_maxMotorTorque;a.motorSpeed=this.m_motorSpeed;a.frequencyHz=this.m_frequencyHz;a.dampingRatio=this.m_dampingRatio;return a}};Eb._extend(s);Fb.prototype={_deserialize:function(a,b,c){this.parent.prototype._deserialize.call(this,a,b,c);this.joint1=a.joint1;this.joint2=a.joint2;this.ratio=a.ratio}};Fb._extend(oa);Gb.prototype={GetAnchorA:function(){return this.m_bodyA.GetWorldPoint(this.m_localAnchorA)},
...
name:"b2RayCastInput",def:sb},{trimmed:"RayCastOutput",name:"b2RayCastOutput",def:Sb},{trimmed:"AABB",name:"b2AABB",def:X},{trimmed:"CollideCircles",name:"b2CollideCircles",def:tc},{trimmed:"CollidePolygonAndCircle",name:"b2CollidePolygonAndCircle",def:uc},{trimmed:"FindMaxSeparation",name:"b2FindMaxSeparation",def:Tb},{trimmed:"FindIncidentEdge",name:"b2FindIncidentEdge",def:vc},{trimmed:"CollidePolygons",name:"b2CollidePolygons",def:fa},{trimmed:"CollideEdgeAndCircle",name:"b2CollideEdgeAndCircle",
def:Ub},{trimmed:"EPAxis",name:"b2EPAxis",def:da},{trimmed:"TempPolygon",name:"b2TempPolygon",def:wc},{trimmed:"ReferenceFace",name:"b2ReferenceFace",def:xc},{trimmed:"EPCollider",name:"b2EPCollider",def:M},{trimmed:"CollideEdgeAndPolygon",name:"b2CollideEdgeAndPolygon",def:db},{trimmed:"ClipSegmentToLine",name:"b2ClipSegmentToLine",def:cb},{trimmed:"TestShapeOverlap",name:"b2TestShapeOverlap",def:ga},{trimmed:"TestOverlap",name:"b2TestOverlap",def:tb},{trimmed:"Shape",name:"b2Shape",def:G},{trimmed:"CircleShape",
name:"b2CircleShape",def:Qa},{trimmed:"EdgeShape",name:"b2EdgeShape",def:Ja},{trimmed:"ChainShape",name:"b2ChainShape",def:qa},{trimmed:"PolygonShape",name:"b2PolygonShape",def:Fa},{trimmed:"Pair",name:"b2Pair",def:rc},{trimmed:"PairLessThan",name:"b2PairLessThan",def:sc},{trimmed:"BroadPhase",name:"b2BroadPhase",def:Ga},{trimmed:"DistanceProxy",name:"b2DistanceProxy",def:Ra},{trimmed:"SimplexCache",name:"b2SimplexCache",def:Nb},{trimmed:"DistanceInput",name:"b2DistanceInput",def:Ob},{trimmed:"DistanceOutput",
name:"b2DistanceOutput",def:Pb},{trimmed:"SimplexVertex",name:"b2SimplexVertex",def:bb},{trimmed:"Simplex",name:"b2Simplex",def:Qb},{trimmed:"DistanceFunc",name:"b2DistanceFunc",def:xa},{trimmed:"TreeNode",name:"b2TreeNode",def:Sa},{trimmed:"DynamicTree",name:"b2DynamicTree",def:Ha},{trimmed:"TOIInput",name:"b2TOIInput",def:yc},{trimmed:"TOIOutput",name:"b2TOIOutput",def:ha},{trimmed:"SeparationFunction",name:"b2SeparationFunction",def:ia},{trimmed:"TimeOfImpact",name:"b2TimeOfImpact",def:R},{trimmed:"BodyDef",
name:"b2BodyDef",def:vb},{trimmed:"Body",name:"b2Body",def:t},{trimmed:"Filter",name:"b2Filter",def:eb},{trimmed:"FixtureDef",name:"b2FixtureDef",def:fb},{trimmed:"Fixture",name:"b2Fixture",def:Vb},{trimmed:"DestructionListener",name:"b2DestructionListener",def:zc},{trimmed:"ContactFilter",name:"b2ContactFilter",def:Wb},{trimmed:"ContactImpulse",name:"b2ContactImpulse",def:Ac},{trimmed:"ContactListener",name:"b2ContactListener",def:Xb},{trimmed:"QueryCallback",name:"b2QueryCallback",def:Bc},{trimmed:"RayCastCallback",
name:"b2RayCastCallback",def:Cc},{trimmed:"TimeStep",name:"b2TimeStep",def:gb},{trimmed:"Position",name:"b2Position",def:Dc},{trimmed:"Velocity",name:"b2Velocity",def:Ec},{trimmed:"SolverData",name:"b2SolverData",def:Fc},{trimmed:"World",name:"b2World",def:P},{trimmed:"MixFriction",name:"b2MixFriction",def:function(a,b){return va(a*b)}},{trimmed:"MixRestitution",name:"b2MixRestitution",def:Zb},{trimmed:"ContactRegister",name:"b2ContactRegister",def:$b},{trimmed:"ContactEdge",name:"b2ContactEdge",
def:ac},{trimmed:"Contact",name:"b2Contact",def:w},{trimmed:"CircleContact",name:"b2CircleContact",def:wb},{trimmed:"PolygonContact",name:"b2PolygonContact",def:Ya},{trimmed:"ChainAndCircleContact",name:"b2ChainAndCircleContact",def:xb},{trimmed:"ChainAndPolygonContact",name:"b2ChainAndPolygonContact",def:Ua},{trimmed:"EdgeAndCircleContact",name:"b2EdgeAndCircleContact",def:Va},{trimmed:"EdgeAndPolygonContact",name:"b2EdgeAndPolygonContact",def:Wa},{trimmed:"PolygonAndCircleContact",name:"b2PolygonAndCircleContact",
def:Xa},{trimmed:"defaultFilter",name:"b2_defaultFilter",def:Jc},{trimmed:"defaultListener",name:"b2_defaultListener",def:Kc},{trimmed:"ContactManager",name:"b2ContactManager",def:Yb},{trimmed:"VelocityConstraintPoint",name:"b2VelocityConstraintPoint",def:Lc},{trimmed:"ContactPositionConstraint",name:"b2ContactPositionConstraint",def:Mc},{trimmed:"ContactVelocityConstraint",name:"b2ContactVelocityConstraint",def:Nc},{trimmed:"PositionSolverManifold",name:"b2PositionSolverManifold",def:bc},{trimmed:"ContactSolverDef",
name:"b2ContactSolverDef",def:Oc},{trimmed:"ContactSolver",name:"b2ContactSolver",def:E},{trimmed:"Island",name:"b2Island",def:K},{trimmed:"Jacobian",name:"b2Jacobian",def:function(){this.linear=new d;this.angularB=this.angularA=0}},{trimmed:"JointEdge",name:"b2JointEdge",def:cc},{trimmed:"JointDef",name:"b2JointDef",def:oa},{trimmed:"Joint",name:"b2Joint",def:s},{trimmed:"RevoluteJointDef",name:"b2RevoluteJointDef",def:hb},{trimmed:"RevoluteJoint",name:"b2RevoluteJoint",def:yb},{trimmed:"MouseJointDef",
name:"b2MouseJointDef",def:Pc},{trimmed:"MouseJoint",name:"b2MouseJoint",def:zb},{trimmed:"DistanceJointDef",name:"b2DistanceJointDef",def:ib},{trimmed:"DistanceJoint",name:"b2DistanceJoint",def:Ab},{trimmed:"PrismaticJointDef",name:"b2PrismaticJointDef",def:jb},{trimmed:"PrismaticJoint",name:"b2PrismaticJoint",def:Bb},{trimmed:"FrictionJointDef",name:"b2FrictionJointDef",def:kb},{trimmed:"FrictionJoint",name:"b2FrictionJoint",def:Cb},{trimmed:"WeldJointDef",name:"b2WeldJointDef",def:lb},{trimmed:"WeldJoint",
name:"b2WeldJoint",def:Db},{trimmed:"WheelJointDef",name:"b2WheelJointDef",def:mb},{trimmed:"WheelJoint",name:"b2WheelJoint",def:Eb},{trimmed:"GearJointDef",name:"b2GearJointDef",def:Fb},{trimmed:"GearJoint",name:"b2GearJoint",def:Gb},{trimmed:"MotorJointDef",name:"b2MotorJointDef",def:nb},{trimmed:"MotorJoint",name:"b2MotorJoint",def:Hb},{trimmed:"PulleyJointDef",name:"b2PulleyJointDef",def:Ib},{trimmed:"PulleyJoint",name:"b2PulleyJoint",def:Jb},{trimmed:"RopeJointDef",name:"b2RopeJointDef",def:ob},
{trimmed:"RopeJoint",name:"b2RopeJoint",def:Kb},{trimmed:"RopeDef",name:"b2RopeDef",def:function(){this.vertices=null;this.count=0;this.masses=null;this.gravity=new d;this.damping=0.1;this.k2=0.9;this.k3=0.1}},{trimmed:"Rope",name:"b2Rope",def:Qc},{trimmed:"maxManifoldPoints",name:"b2_maxManifoldPoints",def:na},{trimmed:"maxPolygonVertices",name:"b2_maxPolygonVertices",def:wa},{trimmed:"aabbExtension",name:"b2_aabbExtension",def:0.1},{trimmed:"aabbMultiplier",name:"b2_aabbMultiplier",def:2},{trimmed:"linearSlop",
...
[];for(c=0;c<a.fixtures.length;++c){g=a.fixtures[c];var k=new fb;k._deserialize(g);k.shape=f[g.shape];d.push(k)}g=[];for(c=0;c<a.bodies.length;++c){f=a.bodies[c];k=new vb;k._deserialize(f);for(var k=b.CreateBody(k),h=0;h<f.fixtures.length;++h)k.CreateFixture(d[f.fixtures[h]]);g.push(k)}d=[];f=[];for(c=0;c<a.joints.length;++c){k=a.joints[c];switch(k.type){case s.e_revoluteJoint:h=new hb;break;case s.e_prismaticJoint:h=new jb;break;case s.e_distanceJoint:h=new ib;break;case s.e_pulleyJoint:h=new Ib;
break;case s.e_gearJoint:h=new Fb;break;case s.e_wheelJoint:h=new mb;break;case s.e_weldJoint:h=new lb;break;case s.e_frictionJoint:h=new kb;break;case s.e_ropeJoint:h=new ob;break;case s.e_motorJoint:h=new nb;break;default:throw Error("unknown joint");}h._deserialize(k,g);k.type===s.e_gearJoint?(f.push([h,d.length]),d.push(null)):(k=b.CreateJoint(h),d.push(k))}for(c=0;c<f.length;++c)f[c][0].joint1=d[f[c][0].joint1],f[c][0].joint2=d[f[c][0].joint2],k=b.CreateJoint(f[c][0]),d[f[c][1]]=k}}},{trimmed:"RUBELoader",
