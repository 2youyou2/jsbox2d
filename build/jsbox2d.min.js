...
3;Jb.prototype={Initialize:function(a,b,c,g,e){if(0!=a.pointCount)switch(a.type){case F.e_circles:this.normal.x=1;this.normal.y=0;var f=b.q.c*a.localPoint.x-b.q.s*a.localPoint.y+b.p.x,h=b.q.s*a.localPoint.x+b.q.c*a.localPoint.y+b.p.y;b=g.q.c*a.points[0].localPoint.x-g.q.s*a.points[0].localPoint.y+g.p.x;a=g.q.s*a.points[0].localPoint.x+g.q.c*a.points[0].localPoint.y+g.p.y;g=f-b;var k=h-a;g*g+k*k>ga*ga&&(this.normal.x=b-f,this.normal.y=a-h,this.normal.Normalize());var f=f+c*this.normal.x,h=h+c*this.normal.y,
...
Wa.prototype={_deserialize:function(a){this.friction=a.friction;this.restitution=a.restitution;this.density=a.density;this.isSensor=a.isSensor;this.filter._deserialize(a.filter)}};Nb.prototype={GetType:function(){return this.m_shape.GetType()},GetShape:function(){return this.m_shape},SetSensor:function(a){a!=this.m_isSensor&&(this.m_body.SetAwake(!0),this.m_isSensor=a)},IsSensor:function(){return this.m_isSensor},SetFilterData:function(a){this.m_filter=a;this.Refilter()},GetFilterData:function(){return this.m_filter},
...
a.localAxisA=this.m_localAxisA._serialize();a.enableMotor=this.m_enableMotor;a.maxMotorTorque=this.m_maxMotorTorque;a.motorSpeed=this.m_motorSpeed;a.frequencyHz=this.m_frequencyHz;a.dampingRatio=this.m_dampingRatio;return a}};wb._extend(s);xb.prototype={_deserialize:function(a,b,c){this.parent.prototype._deserialize.call(this,a,b,c);this.joint1=a.joint1;this.joint2=a.joint2;this.ratio=a.ratio}};xb._extend(ja);yb.prototype={GetAnchorA:function(){return this.m_bodyA.GetWorldPoint(this.m_localAnchorA)},
...
def:X},{trimmed:"MulT_t_v2",name:"b2MulT_t_v2",def:Aa},{trimmed:"Mul_t_t",name:"b2Mul_t_t",def:function(a,b){var c=new $;c.q=ec(a.q,b.q);c.p=d.Add(A(a.q,b.p),a.p);return c}},{trimmed:"MulT_t_t",name:"b2MulT_t_t",def:Eb},{trimmed:"Clamp_v2",name:"b2Clamp_v2",def:function(a,b,c){return kb(b,jb(a,c))}},{trimmed:"NextPowerOfTwo",name:"b2NextPowerOfTwo",def:function(a){a|=a>>1;a|=a>>2;a|=a>>4;a|=a>>8;return(a|a>>16)+1}},{trimmed:"Abs_v2",name:"b2Abs_v2",def:Qa},{trimmed:"Abs_m22",name:"b2Abs_m22",def:function(a){return new U(Qa(a.ex),
...
name:"b2RevoluteJoint",def:qb},{trimmed:"MouseJointDef",name:"b2MouseJointDef",def:Gc},{trimmed:"MouseJoint",name:"b2MouseJoint",def:rb},{trimmed:"DistanceJointDef",name:"b2DistanceJointDef",def:Za},{trimmed:"DistanceJoint",name:"b2DistanceJoint",def:sb},{trimmed:"PrismaticJointDef",name:"b2PrismaticJointDef",def:$a},{trimmed:"PrismaticJoint",name:"b2PrismaticJoint",def:tb},{trimmed:"FrictionJointDef",name:"b2FrictionJointDef",def:ab},{trimmed:"FrictionJoint",name:"b2FrictionJoint",def:ub},{trimmed:"WeldJointDef",
name:"b2WeldJointDef",def:bb},{trimmed:"WeldJoint",name:"b2WeldJoint",def:vb},{trimmed:"WheelJointDef",name:"b2WheelJointDef",def:cb},{trimmed:"WheelJoint",name:"b2WheelJoint",def:wb},{trimmed:"GearJointDef",name:"b2GearJointDef",def:xb},{trimmed:"GearJoint",name:"b2GearJoint",def:yb},{trimmed:"MotorJointDef",name:"b2MotorJointDef",def:db},{trimmed:"MotorJoint",name:"b2MotorJoint",def:zb},{trimmed:"PulleyJointDef",name:"b2PulleyJointDef",def:Ab},{trimmed:"PulleyJoint",name:"b2PulleyJoint",def:Bb},
